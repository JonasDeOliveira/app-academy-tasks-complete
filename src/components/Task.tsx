...
const Task: React.FC<Props> = (props:Props) => {
    ...
    const doneOrNotStyle: object = props.doneAt != null ? 
        { textDecorationLine: 'line-through' } : {}

    const date: string = props.doneAt ? props.doneAt : props.estimateAt
    const formattedDate: string = moment(date).locale('pt-br')
...
function getCheckView(doneAt: string): React.ReactElement {
    if(doneAt != null) {
        return (
